#
#  Be sure to run `pod spec lint CPSelectionManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "yoonhg84"
  # s.authors            = { "yoonhg84" => "yoonhg2002@gmail.com" }
  # s.social_media_url   = "http://twitter.com/yoonhg84"
  ...
  s.source       = { :git => "https://github.com/yoonhg84/CPSelectionManager.git", :tag => "0.0.1" }
